...
$EDUDISPLEJ_TRANSLATIONS = [
    'hu' => [
        ...
        'nav.special_plan' => 'Eseménynaptár',
        'nav.admin' => 'Admin',
        'nav.logout' => 'Kilepes',
        'lang.label' => 'Nyelv',
        'lang.hu' => 'Magyar',
        ...
        'session.timeout.redirecting' => 'Átirányítás a bejelentkezéshez {seconds} mp múlva...',
        ...
        'dashboard.screenshot.open_history' => 'Előzmények megnyitása',
        'dashboard.screenshot.zoom_live' => 'Nagyítás és élő frissítés',
        'dashboard.screen.on' => 'Bekapcsolva',
        'dashboard.screen.off' => 'Kikapcsolva',
        'dashboard.col.screenshot' => 'Screenshot',
        'common.mon' => 'H',
        'common.tue' => 'K',
        'common.wed' => 'Sze',
        'common.thu' => 'Cs',
        ...
        'common.sat' => 'Szo',
        'common.sun' => 'V',
        'dashboard.special_loop.page_title' => 'Eseménynaptár',
        'dashboard.special_loop.group' => 'Csoport',
        'dashboard.special_loop.save_hint_title' => 'Mentés',
        'dashboard.special_loop.save_hint_text' => 'Az eseményt a szerkesztőben tudod elmenteni.',
        'dashboard.special_loop.workflow_title' => 'Eseménynaptár',
        'dashboard.special_loop.workflow_steps_title' => 'Lépések',
        'dashboard.special_loop.workflow_steps_text' => 'A heti terv az alap. Az eseménynaptárban ezeket napokra szóló loopokkal írhatod felül.',
        'dashboard.special_loop.start_workflow' => 'Új esemény',
        'dashboard.special_loop.calendar_title' => 'Havi eseménynaptár',
        'dashboard.special_loop.calendar_hint' => 'A napokra betervezett események felülírják a heti alaptervet.',
        'dashboard.special_loop.more_events' => 'további',
        'dashboard.special_loop.event_list_title' => 'Eseménylista',
        'dashboard.special_loop.event_list_hint' => 'Itt látod a közelgő és már betervezett napokra szóló loopokat.',
        'dashboard.special_loop.when' => 'Időpont',
        'dashboard.special_loop.event_name' => 'Esemény neve',
        'dashboard.special_loop.event_purpose' => 'Cél',
        'dashboard.special_loop.loop' => 'Loop',
        'dashboard.special_loop.status' => 'Állapot',
        'dashboard.special_loop.actions' => 'Műveletek',
        'dashboard.special_loop.status.scheduled' => 'Ütemezve',
        'dashboard.special_loop.status.inactive_expired' => 'Inaktív (lejárt)',
        'dashboard.special_loop.status.active' => 'Aktív',
        'dashboard.special_loop.relative.starts_in' => 'Még {interval} múlva',
        'dashboard.special_loop.relative.elapsed' => 'Már {interval} telt el',
        'dashboard.special_loop.relative.running_remaining' => 'Most fut, még {interval} van hátra',
        'dashboard.special_loop.time.day' => '{count} nap',
        'dashboard.special_loop.time.hour' => '{count} óra',
        'dashboard.special_loop.time.minute' => '{count} perc',
        'dashboard.special_loop.time.less_than_minute' => 'kevesebb mint 1 perc',
        'common.enabled' => 'Engedélyezve',
        'common.hostname' => 'Hostname',
        'common.user' => 'Felhasználó',
        'common.coming_soon' => 'Hamarosan',
        'dashboard.special_loop.unavailable.title' => 'Az Eseménynaptár hamarosan érkezik',
        'dashboard.special_loop.unavailable.body' => 'Ez a funkció átmenetileg nem elérhető. Rövidesen bekapcsoljuk.',
        'dashboard.error.save' => 'Mentési hiba',
        'dashboard.kiosk.prefix' => 'Kioszk #',
    ...
    'en' => [
        ...
        'nav.special_plan' => 'Event Calendar',
        'nav.admin' => 'Admin',
        'nav.logout' => 'Log out',
        'lang.label' => 'Language',
        'lang.hu' => 'Hungarian',
        ...
        'session.timeout.redirecting' => 'Redirecting to login in {seconds} s...',
        ...
        'dashboard.screenshot.open_history' => 'Open history',
        'dashboard.screenshot.zoom_live' => 'Zoom and live refresh',
        ...
        'common.sat' => 'Sat',
        'common.sun' => 'Sun',
        'dashboard.special_loop.page_title' => 'Event Calendar',
        'dashboard.special_loop.group' => 'Group',
        'dashboard.special_loop.save_hint_title' => 'Save',
        'dashboard.special_loop.save_hint_text' => 'You can save the event in the editor.',
        'dashboard.special_loop.workflow_title' => 'Event Calendar',
        'dashboard.special_loop.workflow_steps_title' => 'Steps',
        'dashboard.special_loop.workflow_steps_text' => 'The weekly plan is the baseline. In the event calendar, you can override it with day-specific loops.',
        'dashboard.special_loop.start_workflow' => 'New Event',
        'dashboard.special_loop.calendar_title' => 'Monthly Event Calendar',
        'dashboard.special_loop.calendar_hint' => 'Day-specific planned events override the weekly baseline.',
        'dashboard.special_loop.more_events' => 'more',
        'dashboard.special_loop.event_list_title' => 'Event List',
        'dashboard.special_loop.event_list_hint' => 'Here you can see upcoming and already planned day-specific loops.',
        'dashboard.special_loop.when' => 'Time',
        'dashboard.special_loop.event_name' => 'Event name',
        'dashboard.special_loop.event_purpose' => 'Purpose',
        'dashboard.special_loop.loop' => 'Loop',
        'dashboard.special_loop.status' => 'Status',
        'dashboard.special_loop.actions' => 'Actions',
        'dashboard.special_loop.status.scheduled' => 'Scheduled',
        'dashboard.special_loop.status.inactive_expired' => 'Inactive (expired)',
        'dashboard.special_loop.status.active' => 'Active',
        'dashboard.special_loop.relative.starts_in' => 'Starts in {interval}',
        'dashboard.special_loop.relative.elapsed' => '{interval} elapsed',
        'dashboard.special_loop.relative.running_remaining' => 'Running now, {interval} remaining',
        'dashboard.special_loop.time.day' => '{count} day',
        'dashboard.special_loop.time.hour' => '{count} hour',
        'dashboard.special_loop.time.minute' => '{count} min',
        'dashboard.special_loop.time.less_than_minute' => 'less than 1 min',
        'common.enabled' => 'Enabled',
        'common.hostname' => 'Hostname',
        'common.user' => 'User',
        'common.coming_soon' => 'Soon',
        'dashboard.special_loop.unavailable.title' => 'Event Calendar is coming soon',
        'dashboard.special_loop.unavailable.body' => 'This feature is temporarily unavailable. We will enable it soon.',
        'dashboard.error.save' => 'Save error',
        'dashboard.kiosk.prefix' => 'Kiosk #',
    ...
    'sk' => [
        ...
        'nav.special_plan' => 'Kalendár udalostí',
        'nav.admin' => 'Admin',
        ...
        'session.timeout.redirecting' => 'Presmerovanie na prihlásenie o {seconds} s...',
        ...
        'dashboard.screenshot.open_history' => 'Otvoriť históriu',
        'dashboard.screenshot.zoom_live' => 'Priblíženie a živé obnovenie',
        ...
        'common.sat' => 'So',
        'common.sun' => 'Ne',
        'dashboard.special_loop.page_title' => 'Kalendár udalostí',
        'dashboard.special_loop.group' => 'Skupina',
        'dashboard.special_loop.save_hint_title' => 'Uloženie',
        'dashboard.special_loop.save_hint_text' => 'Udalosť môžete uložiť v editore.',
        'dashboard.special_loop.workflow_title' => 'Kalendár udalostí',
        'dashboard.special_loop.workflow_steps_title' => 'Kroky',
        'dashboard.special_loop.workflow_steps_text' => 'Týždenný plán je základ. V kalendári udalostí ho môžete prepísať dennými loopmi.',
        'dashboard.special_loop.start_workflow' => 'Nová udalosť',
        'dashboard.special_loop.calendar_title' => 'Mesačný kalendár udalostí',
        'dashboard.special_loop.calendar_hint' => 'Naplánované udalosti pre konkrétne dni prepíšu týždenný základ.',
        'dashboard.special_loop.more_events' => 'ďalšie',
        'dashboard.special_loop.event_list_title' => 'Zoznam udalostí',
        'dashboard.special_loop.event_list_hint' => 'Tu vidíte nadchádzajúce aj už naplánované denné loopy.',
        'dashboard.special_loop.when' => 'Čas',
        'dashboard.special_loop.event_name' => 'Názov udalosti',
        'dashboard.special_loop.event_purpose' => 'Účel',
        'dashboard.special_loop.loop' => 'Loop',
        'dashboard.special_loop.status' => 'Stav',
        'dashboard.special_loop.actions' => 'Akcie',
        'dashboard.special_loop.status.scheduled' => 'Naplánované',
        'dashboard.special_loop.status.inactive_expired' => 'Neaktívne (po termíne)',
        'dashboard.special_loop.status.active' => 'Aktívne',
        'dashboard.special_loop.relative.starts_in' => 'Začne o {interval}',
        'dashboard.special_loop.relative.elapsed' => 'Uplynulo {interval}',
        'dashboard.special_loop.relative.running_remaining' => 'Práve beží, zostáva {interval}',
        'dashboard.special_loop.time.day' => '{count} deň',
        'dashboard.special_loop.time.hour' => '{count} hod',
        'dashboard.special_loop.time.minute' => '{count} min',
        'dashboard.special_loop.time.less_than_minute' => 'menej ako 1 min',
        'common.enabled' => 'Povolené',
        'common.hostname' => 'Hostname',
        'common.user' => 'Používateľ',
        'common.coming_soon' => 'Čoskoro',
        'dashboard.special_loop.unavailable.title' => 'Kalendár udalostí bude čoskoro dostupný',
        'dashboard.special_loop.unavailable.body' => 'Táto funkcia je dočasne nedostupná. Čoskoro ju zapneme.',
        'dashboard.error.save' => 'Chyba uloženia',
        'dashboard.kiosk.prefix' => 'Kiosk #',
