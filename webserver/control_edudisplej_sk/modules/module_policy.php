    ...
    return [
        'clock' => [
            ...
            'settings' => [
                ...
                'fontSize' => ['type' => 'int', 'min' => 20, 'max' => 1600, 'default' => 150],
                'timeFontSize' => ['type' => 'int', 'min' => 20, 'max' => 1600, 'default' => 150],
                'dateFontSize' => ['type' => 'int', 'min' => 12, 'max' => 900, 'default' => 48],
                'clockSize' => ['type' => 'int', 'min' => 100, 'max' => 2000, 'default' => 300],
                'showSeconds' => ['type' => 'bool', 'default' => true],
                'showDate' => ['type' => 'bool', 'default' => true],
                'language' => ['type' => 'enum', 'allowed' => ['hu', 'sk', 'en'], 'default' => 'sk'],
                'digitalOverlayEnabled' => ['type' => 'bool', 'default' => false],
                'digitalOverlayPosition' => ['type' => 'enum', 'allowed' => ['auto', 'top', 'center', 'bottom'], 'default' => 'auto'],
            ],
        ],
        'default-logo' => [
            'duration' => ['fixed' => 10],
        ...
        'text' => [
            ...
            'settings' => [
                ...
                'textSizingMode' => ['type' => 'enum', 'allowed' => ['manual', 'fit'], 'default' => 'manual'],
                ...
                'clockOverlayPosition' => ['type' => 'enum', 'allowed' => ['top', 'bottom'], 'default' => 'bottom'],
                ...
                'clockOverlayClockSize' => ['type' => 'int', 'min' => 100, 'max' => 2000, 'default' => 300],
                'clockOverlayDateFormat' => ['type' => 'enum', 'allowed' => ['full', 'short', 'dmy', 'numeric', 'none'], 'default' => 'dmy'],
                'clockOverlayShowYear' => ['type' => 'bool', 'default' => true],
                'clockOverlayLanguage' => ['type' => 'enum', 'allowed' => ['hu', 'sk', 'en'], 'default' => 'sk'],
                'clockOverlayDatePosition' => ['type' => 'enum', 'allowed' => ['below', 'right'], 'default' => 'below'],
                'clockOverlayFontFamily' => ['type' => 'enum', 'allowed' => ['Arial, sans-serif', 'Verdana, sans-serif', 'Tahoma, sans-serif', 'Trebuchet MS, sans-serif', 'Georgia, serif', 'Times New Roman, serif', 'Courier New, monospace', 'Impact, Arial Black, sans-serif'], 'default' => 'Arial, sans-serif'],
                'clockOverlaySeparatorColor' => ['type' => 'color', 'default' => '#22d3ee'],
                'clockOverlaySeparatorThickness' => ['type' => 'int', 'min' => 1, 'max' => 8, 'default' => 2],
            ],
        ],
        'unconfigured' => [
            'duration' => ['fixed' => 60],
        ...
        'meal-menu' => [
            ...
            'settings' => [
                ...
                'language' => ['type' => 'enum', 'allowed' => ['hu', 'sk', 'en'], 'default' => 'sk'],
                'showHeaderTitle' => ['type' => 'bool', 'default' => false],
                'customHeaderTitle' => ['type' => 'string', 'maxLen' => 120, 'default' => ''],
                'showInstitutionName' => ['type' => 'bool', 'default' => false],
                'showBreakfast' => ['type' => 'bool', 'default' => true],
                'showSnackAm' => ['type' => 'bool', 'default' => true],
                'showLunch' => ['type' => 'bool', 'default' => true],
                'showSnackPm' => ['type' => 'bool', 'default' => true],
                'showDinner' => ['type' => 'bool', 'default' => true],
                'mealScheduleEnabled' => ['type' => 'bool', 'default' => true],
                'scheduleBreakfastUntil' => ['type' => 'string', 'maxLen' => 5, 'default' => '10:00'],
                'scheduleSnackAmUntil' => ['type' => 'string', 'maxLen' => 5, 'default' => '11:00'],
                'scheduleLunchUntil' => ['type' => 'string', 'maxLen' => 5, 'default' => '14:00'],
                'scheduleSnackPmUntil' => ['type' => 'string', 'maxLen' => 5, 'default' => '18:00'],
                ...
                'scrollStartDelayMs' => ['type' => 'int', 'min' => 7000, 'max' => 30000, 'default' => 7000],
                'scrollLoopPauseMs' => ['type' => 'int', 'min' => 7000, 'max' => 30000, 'default' => 7000],
                ...
                'showTomorrowAfterEvening' => ['type' => 'bool', 'default' => true],
                'tomorrowAfterMeal' => ['type' => 'enum', 'allowed' => ['snack_pm', 'dinner'], 'default' => 'snack_pm'],
                ...
                'mealTextFontSize' => ['type' => 'float', 'min' => 0.8, 'max' => 4.0, 'default' => 2.2],
                ...
                'smallRowFontPx' => ['type' => 'int', 'min' => 60, 'max' => 260, 'default' => 150],
                'smallScreenStartMode' => ['type' => 'enum', 'allowed' => ['current_onward', 'breakfast_onward', 'lunch_onward', 'dinner_onward'], 'default' => 'current_onward'],
                'smallScreenMaxMeals' => ['type' => 'int', 'min' => 1, 'max' => 5, 'default' => 5],
                'smallHeaderMarqueeSpeedPxPerSec' => ['type' => 'int', 'min' => 8, 'max' => 60, 'default' => 22],
                'smallHeaderMarqueeEdgePauseMs' => ['type' => 'int', 'min' => 200, 'max' => 5000, 'default' => 1200],
                'smallScreenHeaderFontPx' => ['type' => 'int', 'min' => 20, 'max' => 120, 'default' => 40],
                'smallHeaderRowBgColor' => ['type' => 'color', 'default' => '#bae6fd'],
                'smallHeaderRowTextColor' => ['type' => 'color', 'default' => '#000000'],
                'smallHeaderRowClockColor' => ['type' => 'color', 'default' => '#facc15'],
                'smallHeaderRowTitleFontPx' => ['type' => 'int', 'min' => 20, 'max' => 140, 'default' => 58],
                'smallHeaderRowClockFontPx' => ['type' => 'int', 'min' => 20, 'max' => 160, 'default' => 62],
            ],
        ],
        'room-occupancy' => [
