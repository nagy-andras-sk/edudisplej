    ...
    return [
        'clock' => [
            ...
            'settings' => [
                ...
                'timeFontSize' => ['type' => 'int', 'min' => 20, 'max' => 400, 'default' => 120],
                'dateFontSize' => ['type' => 'int', 'min' => 12, 'max' => 220, 'default' => 36],
        ...
        'image-gallery' => [
            ...
            'settings' => [
                ...
                'fitMode' => ['type' => 'enum', 'allowed' => ['cover', 'contain', 'fill'], 'default' => 'cover'],
                ...
                'clockOverlayHeightPercent' => ['type' => 'int', 'min' => 20, 'max' => 40, 'default' => 25],
