    ...
    return [
        ...
        'modules' => [
            ...
            'text' => [
                ...
                'settings_schema' => ['textSourceType', 'textCollectionId', 'textCollectionLabel', 'textCollectionVersionTs', 'textExternalUrl', 'text', 'fontFamily', 'fontSize', 'textSizingMode', 'fontWeight', 'fontStyle', 'lineHeight', 'textAlign', 'textColor', 'bgColor', 'bgImageData', 'scrollMode', 'scrollStartPauseMs', 'scrollEndPauseMs', 'scrollSpeedPxPerSec', 'clockOverlayEnabled', 'clockOverlayPosition', 'clockOverlayHeightPercent', 'clockOverlayTimeColor', 'clockOverlayDateColor', 'clockOverlayClockSize', 'clockOverlayDateFormat', 'clockOverlayShowYear', 'clockOverlayLanguage', 'clockOverlayDatePosition', 'clockOverlayFontFamily', 'clockOverlaySeparatorColor', 'clockOverlaySeparatorThickness'],
            ],
            'unconfigured' => [
                'folder_key' => 'default',
                'folder' => 'default',
            ...
            'meal-menu' => [
                ...
                'settings_schema' => ['companyId', 'siteKey', 'institutionId', 'language', 'showHeaderTitle', 'customHeaderTitle', 'showInstitutionName', 'showBreakfast', 'showSnackAm', 'showLunch', 'showSnackPm', 'showDinner', 'mergeBreakfastSnack', 'mergeLunchSnack', 'mealScheduleEnabled', 'scheduleBreakfastFrom', 'scheduleBreakfastUntil', 'scheduleSnackAmFrom', 'scheduleSnackAmUntil', 'scheduleLunchFrom', 'scheduleLunchUntil', 'scheduleSnackPmFrom', 'scheduleSnackPmUntil', 'scheduleDinnerFrom', 'scheduleDinnerUntil', 'showTomorrowAfterMealPassed', 'hidePassedTodayMeals', 'showMealTypeEmojis', 'showMealTypeSvgIcons', 'centerAlign', 'slowScrollOnOverflow', 'slowScrollSpeedPxPerSec', 'scrollStartDelayMs', 'scrollLoopPauseMs', 'layoutMode', 'showTomorrowInSquare', 'showTomorrowAfterEvening', 'tomorrowAfterMeal', 'fontFamily', 'mealTitleFontSize', 'mealTextFontSize', 'textFontWeight', 'lineHeight', 'wrapText', 'showAppetiteMessage', 'appetiteMessageText', 'showSourceUrl', 'sourceUrl', 'clockOverlayEnabled', 'clockOverlayPosition', 'clockOverlayHeightPercent', 'clockOverlayTimeColor', 'clockOverlayDateColor', 'textOverlayEnabled', 'textOverlayPosition', 'textOverlayHeightPercent', 'textOverlaySourceType', 'textOverlayText', 'textOverlayCollectionJson', 'textOverlayExternalUrl', 'textOverlayFontSize', 'textOverlayColor', 'textOverlaySpeedPxPerSec', 'apiBaseUrl', 'smallRowFontPx', 'smallScreenStartMode', 'smallScreenMaxMeals', 'smallHeaderMarqueeSpeedPxPerSec', 'smallHeaderMarqueeEdgePauseMs', 'smallScreenHeaderFontPx', 'smallHeaderRowBgColor', 'smallHeaderRowTextColor', 'smallHeaderRowClockColor', 'smallHeaderRowTitleFontPx', 'smallHeaderRowClockFontPx', 'largeRightPanelSwitchSec'],
            ],
            'room-occupancy' => [
