    ...
    return [
        ...
        'modules' => [
            ...
            'meal-menu' => [
                ...
                'settings_schema' => ['companyId', 'siteKey', 'institutionId', 'language', 'showHeaderTitle', 'customHeaderTitle', 'showInstitutionName', 'showBreakfast', 'showSnackAm', 'showLunch', 'showSnackPm', 'showDinner', 'mealScheduleEnabled', 'scheduleBreakfastUntil', 'scheduleSnackAmUntil', 'scheduleLunchUntil', 'scheduleSnackPmUntil', 'scheduleDinnerUntil', 'showMealTypeEmojis', 'showMealTypeSvgIcons', 'centerAlign', 'slowScrollOnOverflow', 'slowScrollSpeedPxPerSec', 'scrollStartDelayMs', 'scrollLoopPauseMs', 'layoutMode', 'showTomorrowInSquare', 'showTomorrowAfterEvening', 'tomorrowAfterMeal', 'fontFamily', 'mealTitleFontSize', 'mealTextFontSize', 'textFontWeight', 'lineHeight', 'wrapText', 'showAppetiteMessage', 'appetiteMessageText', 'showSourceUrl', 'sourceUrl', 'clockOverlayEnabled', 'clockOverlayPosition', 'clockOverlayHeightPercent', 'clockOverlayTimeColor', 'clockOverlayDateColor', 'textOverlayEnabled', 'textOverlayPosition', 'textOverlayHeightPercent', 'textOverlaySourceType', 'textOverlayText', 'textOverlayCollectionJson', 'textOverlayExternalUrl', 'textOverlayFontSize', 'textOverlayColor', 'textOverlaySpeedPxPerSec', 'apiBaseUrl', 'smallRowFontPx', 'smallScreenStartMode', 'smallScreenMaxMeals', 'smallHeaderMarqueeSpeedPxPerSec', 'smallHeaderMarqueeEdgePauseMs', 'smallScreenHeaderFontPx', 'smallHeaderRowBgColor', 'smallHeaderRowTextColor', 'smallHeaderRowClockColor', 'smallHeaderRowTitleFontPx', 'smallHeaderRowClockFontPx'],
            ],
            'room-occupancy' => [
